const API_BASE_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : 'https://soterosbackend-production.up.railway.app/api');
...
const getApiBaseUrl = () => {
  ...
  return 'https://soterosbackend-production.up.railway.app/api';
};
